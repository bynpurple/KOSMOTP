	  	...
	  	<div class="col-12">
		  	<div class="box box-solid bg-dark">
				<div class="box-header">
					...
					<h6 class="subtitle">아래의 공지사항을 확인해주세요</h6>
				</div>
					...
					<tbody>
						<c:forEach var ="dto" items = "${dto}">
							<tr>
								...
								<th align="center">
									<a href = "noticeContentForm?nonum=${dto.nonum}">${dto.subject}</a>
								</th>
								<th align="center">
									${dto.readCnt}
								</th>
								<th align="center">
									<fmt:formatDate type = "both" pattern = "yyyy-MM-dd HH:mm" value = "${dto.ref_date}"/>
								</th>
							</tr>
						</c:forEach>
					</tbody>
          ...
          <div class="box-body">
			  <div class="table-responsive">
				<table id="example1" class="table table-bordered table-striped">
					...
					<a href="${path}/admin/noticeWrite" style="width:150px;" type="button" class="btn btn-block btn-default btn-lg">작성하기</a>
				  </table>
			  </div>
          </div>
          </c:if>
