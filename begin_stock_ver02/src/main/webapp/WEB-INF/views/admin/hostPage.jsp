        ...
        <div class="col-lg-3 col-12">
          ...
          <div class="box bg-inverse bg-dark bg-hexagons-white">
            <div class="box-body box-profile">
              <img class="profile-user-img rounded-circle img-fluid mx-auto d-block" src="${project}images/5.jpg" alt="User profile picture">
              ...
              <div class="col-6 text-right"><a href="#" class="link text-white"><i class="ion ion-ios-people-outline"></i> ${minusCnt}</a></div>
           </div>
            
              <div class="row">
                 <div class="col-12">
                    <div class="profile-user-info">
                  <p><i class="fa fa-envelope pr-15"></i>${vo.username}</p>
                  <p><i class="fa fa-phone pr-15"></i>${vo.hp}</p>
                        ...
                        <tr>
                           ...
                           <c:forEach var ="dto" items = "${dto}">
                              <tr>
                                 ...
                                 <td align="center">
                                    <fmt:formatDate type = "both" pattern = "yyyy-MM-dd HH:mm" value = "${dto.join_date}"/>
                                 </td>
                              </tr>
                           </c:forEach>
                        </tbody>
                       ...
                       <table id="example5" class="table table-hover">
                        ...
                        <tr>
                           ...
                           <c:forEach var ="dto" items = "${dto}">
                              <tr>
                                 <td align="center">
                                    <a href = "test?username=${dto.username}">${dto.username}</a>
                                 </td>
                                 <td align="center">
                                    ${dto.name}
                                 </td>
                                 <td align="center">${dto.hold}</td>
                                 <td align="center">${dto.enabled}</td>
                              </tr>
                           </c:forEach>
                        </tbody>
                       </table>
