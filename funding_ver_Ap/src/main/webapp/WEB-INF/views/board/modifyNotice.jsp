...
<div class="content" style="max-width: 1265px;">
    ...
    <form action="${path}/user/modifyNoticePro" method="post">
    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
    <input type="hidden" name="notice_id" value = "${dto.notice_id}">
	<!-- 아래 3줄 지우지 마세요 -->
	　
	<input type = "text" class = "form-control" name = "notice_subject" placeholder="${dto.notice_subject}" required>
	　
	<!-- 위에 3줄 지우지 마세요 -->
    ...
    <div id="balloon" class="tabcontent" style="width:1265px;">
   		 <form action = "${path}/user/modifyEventPro" method = "post">
		    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
