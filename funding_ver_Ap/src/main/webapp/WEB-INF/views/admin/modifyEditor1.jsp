...
<html lang="ko">
    ...
    <body id="page-top" data-spy="scroll" data-target=".navbar">
        ...
        <c:if test="${edit1 == 1}">
 		<form action = "modifyEditor2" method="post">
        ...
        <div class="container" style="padding-top:0px;">
		    ...
		    <h3 class="box-title">펀딩 게시글 작성 (2)<br></h3>
		    <input type="text" class="form-control" name="subject" value="비즈니스 전략" readonly>
		    </div>
		  <!-- /.box-header -->
		  <div class="box-body" >
		          <textarea id="editor1" name="editor1" rows="10" cols="80" required>
		             ${Fundvo.fund_str_business}
		          </textarea>
		   </div>
		</div>
		</div>
		...
		<div class="container" style="padding-top:0px;">
           <div class="col-md-12" style="padding-bottom:0px;">
		 	...
		 	<div class="box-header">
		    <input type="text" class="form-control" name="subject" value="상세 내용" readonly>
		    </div>
		    <div class="box-body">
		          <textarea id="editor2" name="editor2" rows="10" cols="80" required>
		             ${Fundvo.fund_detail_content}
		          </textarea>
		    </div>
		    <br><br>
		    <div align="center">
