...
public class Stock_StockVO {
	...
	private long totalStock;		//총 주식량
	private int mkt_cap;		//시가 총액
	private Timestamp stockDate;//상장 날짜(예약 시작 날짜)
	private Timestamp endstockdate; //예약 마감 날짜
	...
	public Timestamp getEndstockdate() {
		return endstockdate;
	}
	public void setEndstockdate(Timestamp endstockdate) {
