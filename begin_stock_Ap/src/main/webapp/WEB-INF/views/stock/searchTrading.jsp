										...
										<tbody>
											...
											<c:if test="${cnt>0}">
												<c:forEach var="list" items="${list}">
													<tr>
														<th scope="col">${list.stockname}</th>
														<th scope="col">${list.stockcode}</th>
														<th scope="col"><fmt:formatNumber type="number" maxFractionDigits="3" value="${list.c_cnt}"/></th>
														<th scope="col"><fmt:formatNumber type="number" maxFractionDigits="3" value="${list.c_price}"/></th>
														<th scope="col"><fmt:formatNumber type="number" maxFractionDigits="3" value="${list.c_total}"/></th>
														<th scope="col"><fmt:formatDate type="both"
																pattern="yyyy-MM-dd HH:mm:ss" 
																value="${list.c_date}" /></th>
													</tr>
												</c:forEach>
											</c:if>
											<!-- 게시글이 없으면 -->
										...
										<tbody>
											...
											<c:if test="${cnt1>0}">
												<c:forEach var="list1" items="${list1}">
													<tr>
														<th scope="col">${list1.stockname}</th>
														<th scope="col">${list1.stockcode}</th>
														<th scope="col"><fmt:formatNumber type="number" maxFractionDigits="3" value="${list1.c_cnt}"/></th>
														<th scope="col"><fmt:formatNumber type="number" maxFractionDigits="3" value="${list1.c_price}"/></th>
														<th scope="col"><fmt:formatNumber type="number" maxFractionDigits="3" value="${list1.c_total}"/></th>
														<th scope="col"><fmt:formatDate type="both"
																pattern="yyyy-MM-dd HH:mm:ss" 
																value="${list1.c_date}" /></th>
													</tr>
												</c:forEach>
											</c:if>
											<!-- 게시글이 없으면 -->
